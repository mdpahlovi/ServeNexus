...
export default async function UpdateService({ params }: { params: Promise<{ id: string }> }) {
    const data = await getService((await params).id);
    ...
    return (
        <main className="container mx-auto p-4 sm:p-6 flex-1 flex flex-col gap-4 sm:gap-6">
            <div className="flex justify-start items-center gap-4">
                ...
                <h1 className="text-3xl font-bold tracking-tight">Update Service</h1>
            </div>
